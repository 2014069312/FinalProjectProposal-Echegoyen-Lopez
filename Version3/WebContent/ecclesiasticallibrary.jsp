...
out.println("</div>" +
			"</div>");
out.println("<br><br><br>" + "<div class='titleheader'>Ecclesiastical Library</div>" + "<br>");
out.println("<img src='lib02.png' width='60%'>" + "<br>" + "<img src='ecclesiasticallib.png' width='70%'>");

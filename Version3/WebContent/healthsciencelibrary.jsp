...
<body>
	...
	out.println("</div>" +
				"</div>");
	out.println("<br><br><br>" + "<div class='titleheader'>Health Science Library</div>" + "<br>");
	out.println("<img src='lib04.png' width='70%'>" + "<br><br><br>" + "<img src='healthscilib.png' width='70%'>");

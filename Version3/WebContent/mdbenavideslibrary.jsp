...
out.println("</div>" +
			"</div>");
out.println("<br><br><br>" + "<div class='titleheader'>Miguel de Benavides Library</div>" + "<br>");
out.println("<img src='lib05.png' width='70%'>" + "<br><br><br>" + "<img src='centrallib.png' width='70%'>");

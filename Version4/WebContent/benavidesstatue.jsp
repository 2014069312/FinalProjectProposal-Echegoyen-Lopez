...
<%
	...
	out.println("</div>" +
				"</div>");
	out.println("<br><br><br>" + "<br><br><br><div class='titleheader'>Miguel de Benavides Statue</div><br><br><br><br>");
	out.println("<img src='benavidesinfo.png' width='60%'>" + "<br><br><img src='soft slit separator.png' width='60%'><br><br>");
	out.println("<img src='USTBenavides.png' width='60%'>" + "<br><br><br>");

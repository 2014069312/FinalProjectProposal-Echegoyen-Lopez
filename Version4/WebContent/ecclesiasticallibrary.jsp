...
out.println("</div>" +
			"</div>");
out.println("<br><br><br>" + "<br><br><br><div class='titleheader'>Ecclesiastical Library</div>" + "<br><br><br>");
out.println("<img src='lib02.png' width='40%'> &nbsp; &nbsp; <img src='ecclesiasticallib.png' width='40%'>"
			+ "<br><br><img src='soft slit separator.png' width='60%'><br><br>" + "<img src='USTMapEcclesiastical.png' width='70%'>");

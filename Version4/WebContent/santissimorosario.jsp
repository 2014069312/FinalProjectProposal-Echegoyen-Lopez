...
<%
	...
	out.println("</div>" +
				"</div>");
	out.println("<br><br><br>" + "<br><br><br><div class='titleheader'>Santissimo Rosario Parish</div><br><br><br>");
	out.println("<img src='santissimorosarioinfo.png' width='60%'>" + "<br><br><img src='soft slit separator.png' width='60%'><br><br>");
	out.println("<img src='USTMapSantissimoRosario.png' width='60%'>" + "<br><br><br>");

...
<%
	...
	out.println("</div>" +
				"</div>");
	out.println("<br><br><br>" + "<br><br><br><div class='titleheader'>Arch of the Centuries</div><br><br><br>");
	out.println("<img src='archinfo.png' width='60%'>" + "<br><br><img src='soft slit separator.png' width='60%'><br><br>");
	out.println("<img src='USTMapArch.png' width='60%'>" + "<br><br><br>");

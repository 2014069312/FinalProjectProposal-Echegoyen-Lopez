...
out.println("</div>" +
			"</div>");
out.println("<br><br><br>" + "<br><br><br><div class='titleheader'>Miguel de Benavides Library</div>" + "<br><br><br><br><br><br>");
out.println("<img src='lib05.png' width='40%'> &nbsp; &nbsp; <img src='centrallib.png' width='40%'>"
			+ "<br><br><img src='soft slit separator.png' width='60%'><br><br>" + "<img src='USTBenavidesLibrary.png' width='70%'>");

...
<%
	...
	out.println("</div>" +
				"</div>");
	out.println("<br><br><br>" + "<br><br><br><div class='titleheader'>Fountain of Wisdom</div>" + "<br><br><br>");
	out.println("<img src='fountainofwisdominfo.png' width='60%'>" + "<br><br><img src='soft slit separator.png' width='60%'><br><br>");
	out.println("<img src='USTWisdom.png' width='60%'>" + "<br><br><br>");

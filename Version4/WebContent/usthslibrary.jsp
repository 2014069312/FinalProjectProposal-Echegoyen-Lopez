...
out.println("</div>" +
			"</div>");
out.println("<br><br><br>" + "<br><br><br><div class='titleheader'>UST High School Library</div><br><br><br><br><br><br>");
out.println("<img src='lib03.png' width='40%'> &nbsp; &nbsp; <img src='highschoollib.png' width='40%'>"
			+ "<br><br><img src='soft slit separator.png' width='60%'><br><br>" + "<img src='USTMapHSLibrary.png' width='70%'>");

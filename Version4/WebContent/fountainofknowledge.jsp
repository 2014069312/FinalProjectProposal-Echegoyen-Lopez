...
<%
	...
	out.println("</div>" +
				"</div>");
	out.println("<br><br><br>" + "<br><br><br><div class='titleheader'>Fountain of Knowledge</div>" + "<br><br><br>");
	out.println("<img src='fountainofknowledgeinfo.png' width='60%'>" + "<br><br><img src='soft slit separator.png' width='60%'><br><br>");
	out.println("<img src='USTKnowledge.png' width='60%'>" + "<br><br><br>");

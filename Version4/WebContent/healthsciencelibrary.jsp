...
<body>
	...
	out.println("</div>" +
				"</div>");
	out.println("<br><br><br>" + "<br><br><br><div class='titleheader'>Health Science Library</div>" + "<br><br><br><br><br><br>");
	out.println("<img src='lib04.png' width='40%'> &nbsp; &nbsp; <img src='healthscilib.png' width='40%'>"
				+ "<br><br><img src='soft slit separator.png' width='60%'><br><br>" + "<img src='USTMapHealthScience.png' width='70%'>");

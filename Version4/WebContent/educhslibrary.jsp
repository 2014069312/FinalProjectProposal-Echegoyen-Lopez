...
<body>
	...
	out.println("</div>" +
				"</div>");
	out.println("<br><br><br>" + "<br><br><br><div class='titleheader'>Education High School Library</div>" + "<br><r><br>");
	out.println("<img src='lib1.png' width='40%'> &nbsp; &nbsp; <img src='educlib.png' width='40%'>"
				+ "<br><br><img src='soft slit separator.png' width='60%'><br><br>" + "<img src='USTMapEducHS.png' width='70%'>");
